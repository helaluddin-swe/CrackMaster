...
import RelatedQuestions from './RelatedQuestions'; // Import your new component

const QuestionCard = ({ question, index, answered, onOptionSelect, onToggleBookmark, isBookmarked }) => {
    ...
    <div className={`p-4 sm:p-6 rounded-2xl border shadow-sm transition-all duration-300 ${theme.card}`}>
      <div className="flex gap-3 sm:gap-4 items-start">
        ...
        <div className="flex-1 space-y-4 pt-1">
          ...
          {/* RELATED QUESTIONS COMPONENT INTEGRATION */}
          {answered && (
            <RelatedQuestions relatedQuestions={question.relatedQuestions} />
          )}
        </div>
      </div>
    </div>
